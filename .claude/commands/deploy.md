...
**This is production and outward-facing — confirm before the privileged step unless the user clearly just said to deploy.** Prod now runs **v27.0.1 `mendicant-bias`** (v27.0.0 shipped 2026-06-22, v27.0.1 promoted 2026-06-23; merge-to-`main` is the autodeploy trigger). Each prod promotion stays a **separate owner-gated** decision — don't push `main` / promote unless the owner explicitly says so.
